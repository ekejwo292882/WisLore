کانال یوتوب : [https://www.youtube.com/@WisLoreVpnHub](https://www.youtube.com/@WisLoreVpnHub)
...
| متغیر | توضیح | پیش‌فرض |
|---|---|---|
| `ADMIN_PASSWORD` | رمز عبور ورود به داشبورد وب | `WisLore` |
...
WisLore · پشتیبانی: [@Farajian2004f](https://t.me/Farajian2004f)
